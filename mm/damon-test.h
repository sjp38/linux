...
{
	struct damon_ctx *c = debugfs_contexts[0];
	struct damon_target *t;
...
{
	struct damon_ctx *ctx = debugfs_contexts[0];
...
static void damon_cleanup_global_state(void)
{
	...
	damon_for_each_target_safe(t, next, debugfs_contexts[0])
		damon_destroy_target(t);

	debugfs_contexts[0]->rbuf_offset = 0;
}
...
static void damon_test_write_rbuf(struct kunit *test)
{
	...
	damon_set_recording(debugfs_contexts[0], 4242, "damon.data");
	...
	damon_set_recording(debugfs_contexts[0], 0, "damon.data");
}
				...
				unsigned long *expected, int nr_expected)
{
	...
	damon_add_target(debugfs_contexts[0], t);

	damon_apply_three_regions(debugfs_contexts[0], t, three_regions);
...
static void damon_test_split_at(struct kunit *test)
{
	...
	r = damon_new_region(0, 100);
	damon_add_region(r, t);
	damon_split_region_at(debugfs_contexts[0], r, 25);
...
static void damon_test_split_regions_of(struct kunit *test)
{
	...
	damon_add_region(r, t);
	damon_split_regions_of(debugfs_contexts[0], t, 2);
	...
	damon_add_region(r, t);
	damon_split_regions_of(debugfs_contexts[0], t, 4);
