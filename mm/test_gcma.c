...
static int test_gcma_alloc_from_contiguous(void)
{
...
static int __init init_gcma(void)
{
	...
	if (test_gcma_alloc_from_contiguous()) {
		pr_warn("[FAIL] test_gcma_alloc_from_contiguous\n");
		return -1;
	}
	pr_info("[SUCCESS] test_gcma_alloc_from_contiguous\n");
