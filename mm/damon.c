...
static void kdamond_prepare_phys_access_checks(struct damon_ctx *ctx)
{
	struct damon_task *t;
	struct damon_region *r;
...
static unsigned int kdamond_check_phys_accesses(struct damon_ctx *ctx)
{
	struct damon_task *t;
	struct damon_region *r;
	unsigned int max_nr_accesses = 0;
...
static void kdamond_update_phys_regions(struct damon_ctx *ctx)
{
	/* do nothing */
}
