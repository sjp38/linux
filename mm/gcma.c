...
static int gcma_frontswap_store(unsigned type, pgoff_t offset, struct page *page)
{
	return 0;
}

static int gcma_frontswap_load(unsigned type, pgoff_t offset, struct page *page)
{
	return 0;
}
