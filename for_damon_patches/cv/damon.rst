...
Changes from Previous Version (v29)
===================================
...
- Rebase on latest -mm tree (v5.13-rc6-mmots-2021-06-14-22-17)
...
For easier review of changes between different versions, I also uploaded all
versions of patchset to a git tree (https://github.com/sjp38/damon-patches).
Please refer to 'Git Tree for Diff of Patches' section below for detail.
...
v5.13-rc6-mmots-2021-06-14-22-17 of https://github.com/hnaz/linux-mm.  You can
also clone the complete git tree:

    $ git clone git://github.com/sjp38/linux -b damon/patches/v30

The web is also available:
https://github.com/sjp38/linux/releases/tag/damon/patches/v30
...
- Wordsmith the document (Markus Boehme)
- Fix a typo in comments (Fernand Sieber)
- Add 'Reviewed-by:' tags from "Fernand Sieber <sieberf@amazon.com>"
...
Please refer to the v20 patchset to get older history.
