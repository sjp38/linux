...
For easier review of changes between different versions of patchset, I also
uploaded all versions of patchset to a git tree
(https://github.com/sjp38/damon-patches).  Please refer to 'Git Tree for Diff
of Patches' section below for detail.
...
versions of the patchset.  For example:
    ...
    $ git clone https://github.com/sjp38/damon-patches
