 ...
 * space and usecase via the &damon_ctx.operations.  Then, the monitoring thread
 ...
 *
 * Each &struct damon_operations instance should have valid @id and registered
 * via damon_register_operations().
