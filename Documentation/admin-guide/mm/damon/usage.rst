...
.. parsed-literal::
    ...
    │ │ │ │ │ │ access_cheeck/primitives/page_table_scan,page_faults
    │ │ │ │ │ │ access_cheeck/filters/nr_filters
...
sysfs interface to periodically update those using ``refresh_ms``, or do an one
